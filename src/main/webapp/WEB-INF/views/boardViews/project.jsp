      ...
      <div role="list" class="list-projects-b w-dyn-items">
        <div role="listitem" class="w-dyn-item">
          ...
          <div class="top-wrap-project-b">
            <div class="text-block-heading-3-styles">Word Blast</div>
            <div class="text-block-heading-3-styles servie-projects-b">23.10.11</div>
          </div>
          ...
          <p class="no-margins">Crating usable and engaging e-commerce platform for leading materials manufacturer.
          ddrating usable and engaging e-commerce platform for leading materials manufacturer.
            rating usable and engaging e-commerce platform for leading materials manufacturer.
            rating usable and engaging e-commerce platform for leading materials manufacturer.
            rating usable and engaging e-commerce platform for leading materials manufacturer.
            rating usable and engaging e-commerce platform for leading materials manufacturer.</p>
        </div>
