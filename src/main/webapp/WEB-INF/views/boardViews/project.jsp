...
<div style="margin-left: 25px; margin-right: 25px">
  <h3 style="font-size: 30px; color: #d39e00; line-height: 1.4;">
    5개월 과정동안 했던 미니 프로젝트를 간단히 넣어봤습니다. 앞으로 만들 프로젝트들도 올릴 곳입니다.
  이미지를 클릭하시면 시연영상과 시연해 보실 수 있습니다.</h3>
</div>
<div style=" max-width: 1000px; margin: 0 auto;" id="top" class="section projects-a">
  <div class="main-container w-container">
    <h1 data-w-id="16cfbc97-3818-6f4c-23d0-e154a4034af6"
        ...
        opacity:0">Here's the project I created.</h1>
      ...
      <div role="list" class="list-projects-b w-dyn-items">
        <div role="listitem" class="w-dyn-item">
          ...
          <p class="no-margins">It is an English learning program that combines translation, TTS(Text to speech), and chatGPT technology using 'API'.
            You can upload scripts of your favorite dramas and become the main character yourself.
    ...
    <div class="w-dyn-list">
      <div role="list" class="list-projects-b w-dyn-items">
        <div role="listitem" class="w-dyn-item">
          ...
          <p class="no-margins">I've created a tower defense game in a project called 'Creating Games with JavaScript'. Try it just for fun.I bet You probably won't last more than 10 minutes.</p>
          <div style="text-align: right; margin-top: 10px">
            <a href="https://github.com/sdjongil/towerDefense.git" target="_blank">Go to github</a>
          </div>
        </div>
        <div class="space-40 line-bottom"></div>
      </div>
