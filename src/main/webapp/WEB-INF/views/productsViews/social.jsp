        ...
        <div class="center-text">
            <div class="center-content">
                <div class="master-product-page">
                    ...
                    <div class="big-text">Understanding others broadens your perspective.</div>
                    ...
                    <div class="master-product-visuals">
                        <h3>I try to listen to what others have to say.When I listen to others' thoughts, I feel that my perspective becomes broader.</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-social2.JPG')" class="image-wrap-product-main-image"></div>
                        <h3> That's why I'm learning English. I want to talk to more varied people</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-social3.JPG')" class="image-wrap-product-main-image"></div>
                        <h3>I love spending time with people doing things together and talking.</h3>
                    </div>
                </div>
