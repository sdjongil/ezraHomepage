        ...
        <div class="center-text">
            <div class="center-content">
                <div class="master-product-page">
                    <h1>Exploratory activity</h1>
                    <div class="big-text">The curious explorer</div>
                    ...
                    <div class="master-product-visuals">
                        <h3> When I get stuck on a problem, I keep trying. Once upon a time, I wanted a good computer, but I didn't have the money.</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-exploratory1.JPG')" class="image-wrap-product-main-image"></div>
                        <h3> When I saw an 'xeon e5-2690 cpu' at a antique shop, I took it for five dollars.
                            That was the beginning of the problem.
                            A server CPU needed server ram, a motherboard, a case, etc.</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-exploratory2.JPG')" class="image-wrap-product-main-image"></div>
                        <h3>But I did it. For about $200, I built a pretty good computer that I still use to this day.</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-exploratory3.JPG')" class="image-wrap-product-main-image"></div>
                        <h3>Another time, a house I tried to buy at an estate sale had legal issues.
                            Again, I finally did it, after three months of studying.</h3>
                    </div>
                </div>
