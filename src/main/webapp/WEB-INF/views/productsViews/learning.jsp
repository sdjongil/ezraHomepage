        ...
        <div class="center-text">
            <div class="center-content">
                <div class="master-product-page">
                    ...
                    <div class="big-text">I love learning about my field. I have a desire to grow in the professionalism of my job.</div>
                    ...
                    <div class="master-product-visuals">
                        <h3> For example, when I joined Forest Preschool, I studied the activities we could do in the forest.</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-learning2.JPG');" class="image-wrap-product-main-image"></div>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-learning3.JPG');" class="image-wrap-product-main-image"></div>
                        <h3> When I became a PE teacher, I studied a good education program.</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-learning4.JPG');" class="image-wrap-product-main-image"></div>
                        <h3>There was no place to learn in Korea, so I taught myself by translating books from Japanese.
                            Later on, I was given the opportunity to teach at my alma mater</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-learning5.JPG');" class="image-wrap-product-main-image"></div>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-learning6.JPG');" class="image-wrap-product-main-image"></div>
                        <h3>It's fun to be an expert at something</h3>
                    </div>
                </div>
