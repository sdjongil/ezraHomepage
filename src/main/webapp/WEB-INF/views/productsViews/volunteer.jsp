        ...
        <div class="center-text">
            <div class="center-content">
                <div class="master-product-page">
                    <h1>Volunteerism</h1>
                    <div class="big-text">The things I can do around me</div>
                    ...
                    <div class="master-product-visuals">
                        <h3> I tend to volunteer within my circle of influence.
                        When I was a kindergarten teacher, I used to do bubble show at Education Welfare Voucher
                        on the weekends for kids.</h3>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-volunteer3.jpg')" class="image-wrap-product-main-image"></div>
                        <div style="background-image:url('../../../resources/static/images/ezra-image-volunteer4.jpg')" class="image-wrap-product-main-image"></div>

                        <h3> Or, when I go camping, I take care of the environment.</h3>
                        <div>
                            <div style="background-image:url('../../../resources/static/images/ezra-image-volunteer7.jpg')" class="image-wrap-product-main-image"></div>
                        </div>
                    </div>
                </div>
